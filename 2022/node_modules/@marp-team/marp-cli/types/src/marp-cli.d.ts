...
export declare type MarpCLIAPIOptions = Pick<MarpCLIInternalOptions, 'baseUrl'>;
export declare type ObservationHelper = {
    stop: () => void;
};
export declare const marpCli: (argv: string[], { baseUrl, stdin, throwErrorAlways }: MarpCLIInternalOptions) => Promise<number>;
