...
export declare class IsolatedWorld {
    ...
    constructor(frame: Frame, injected?: boolean);
    frame(): Frame;
    clearContext(): void;
    ...
    _waitForSelectorInPage(queryOne: Function, root: ElementHandle<Node> | undefined, selector: string, options: WaitForSelectorOptions, binding?: PageBinding): Promise<JSHandle<unknown> | null>;
