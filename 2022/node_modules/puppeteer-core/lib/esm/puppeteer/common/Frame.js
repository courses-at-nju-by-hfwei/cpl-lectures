...
export class Frame {
    ...
    async addScriptTag(options) {
        ...
        return this.worlds[MAIN_WORLD].transferHandle(await this.worlds[PUPPETEER_WORLD].evaluateHandle(async ({ url, id, type, content }) => {
    ...
    async addStyleTag(options) {
        ...
        return this.worlds[MAIN_WORLD].transferHandle(await this.worlds[PUPPETEER_WORLD].evaluateHandle(async ({ url, content }) => {
            const promise = InjectedUtil.createDeferredPromise();
            let element;
            if (!url) {
